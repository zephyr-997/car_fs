#ifndef     __STC32G_H__ // MODIFIED: Header Guard to be consistent
#define     __STC32G_H__ // MODIFIED: Header Guard to be consistent
...
// ADDED: Compatibility definitions for older STC32Gxx.h
#define T2CT       T2_CT       // For AUXR register bit T2CT (Original STC32Gxx.h used T2CT for AUXR^3)
#define PIN_IP     PINIPL      // For Interrupt Pin Priority register (Low byte) (Original STC32Gxx.h used PIN_IP)
#define PCA_VECTOR 7           // 003BH (Present in STC32Gxx.h, commented in original STC32G.H)
#define CAN_VECTOR CAN1_VECTOR  // Original STC32Gxx.h used CAN_VECTOR for 00E3H, STC32G.H uses CAN1_VECTOR
// END ADDED: Compatibility definitions
...
sbit        S1M0x6      =           AUXR^5;
sbit        T2R         =           AUXR^4;
sbit        T2_CT       =           AUXR^3; // Base file (B) uses T2_CT
sbit        T2x12       =           AUXR^2;
sbit        EXTRAM      =           AUXR^1;
sbit        S1BRT       =           AUXR^0;
sfr         INTCLKO     =           0x8f;
...
// Base file (B) uses PWMB_CCR5-8 for these addresses
...
// ADDED: Compatibility for STC32Gxx.h's PWMB_CCR1-4 names
#define     PWMB_CCR1H              PWMB_CCR5H
#define     PWMB_CCR1L              PWMB_CCR5L
#define     PWMB_CCR2H              PWMB_CCR6H
#define     PWMB_CCR2L              PWMB_CCR6L
#define     PWMB_CCR3H              PWMB_CCR7H
#define     PWMB_CCR3L              PWMB_CCR7L
#define     PWMB_CCR4H              PWMB_CCR8H
#define     PWMB_CCR4L              PWMB_CCR8L
// END ADDED: Compatibility for PWMB_CCR1-4
...
// MODIFIED: Uncommented PWMA and PWMB struct pointers
...
#define     PINIPL                  (*(unsigned char volatile far *)0x7efd60) // Base file (B) uses PINIPL
...
//#define   PCA_VECTOR              7       //003BH // Kept commented as in original B, user can uncomment if needed via previous #define
...
//#define   PWM_VECTOR              22      //00B3H // Kept commented as in original B
//#define   PWMFD_VECTOR            23      //00BBH // Kept commented as in original B
#define     I2C_VECTOR              24      //00C3H
#define     USB_VECTOR              25      //00CBH
#define     PWMA_VECTOR             26      //00D3H
#define     PWMB_VECTOR             27      //00DBH
#define     CAN1_VECTOR             28      //00E3H // Base file (B) uses CAN1_VECTOR
...
// ADDED: CHIPID related frequency macros from STC32Gxx.h
...
// END ADDED: CHIPID related frequency macros
